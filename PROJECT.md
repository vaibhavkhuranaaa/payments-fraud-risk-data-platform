...
- **Demo status:** Existing aggregate-only public demo; current full-row revision is a locally verified release candidate awaiting infrastructure and deployment approval.
